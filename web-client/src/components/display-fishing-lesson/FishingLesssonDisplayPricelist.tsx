...
const FishingLessonDisplayPricelist = () => {
  ...
  const addNewService =
    ...
    (event: React.MouseEvent<HTMLButtonElement>) => {
      axios
        .post('/api/fishingLessons/addService/' + params.id, service, {
          headers: {
            Accept: 'application/json',
            'Content-type': 'application/json',
            Authorization:
  ...
  const removeService =
    (index: number) => (event: React.MouseEvent<HTMLButtonElement>) => {
      axios
        .delete('/api/fishingLessons/deleteService/' + index, {
          headers: {
            Accept: 'application/json',
            'Content-type': 'application/json',
            Authorization:
...
export default FishingLessonDisplayPricelist;
